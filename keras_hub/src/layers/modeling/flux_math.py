...
#         #x = ops.reshape(x,[x_shape[0], x_shape[1], x_shape[3], x_shape[2]])
#         x_squashed = True
#     else:
#         x_squashed = False
#
...
#         y_squashed_shape = [y_shape[0], y_shape[1], y_shape[3],y_shape[2]]
...
#     print('x-',x.shape)
#     print('y-',y.shape)
#     #result = tf.matmul(tf.convert_to_tensor(x), tf.convert_to_tensor(y))#ops.dot(x,y)# ops.matmul(x, y)
#     import os
#     os.environ["CUDA_VISIBLE_DEVICES"] = "0"
#     result = tf.matmul(tf.convert_to_tensor(x), tf.convert_to_tensor(y))
